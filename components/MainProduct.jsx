...
const MainProduct = () => {
  return (
    <div className='w-full bg-black flex justify-center pb-10 relative'>
      <Image
        src={'/mainImage.jpeg'}
        alt='PRS Guitar'
        width={1900}
      ...
      />
      <div className='text-white absolute top-3 sm:top-1/3 md:top-1/4 lg:top-1/2 left-10 md:left-32 lg:left-56 w-1/2 space-y-2'>
